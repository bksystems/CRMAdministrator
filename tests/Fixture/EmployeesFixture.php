...
class EmployeesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'roster' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'roster' => ['type' => 'unique', 'columns' => ['roster'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
