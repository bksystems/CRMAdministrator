...
class RolsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'rol_name' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'enabled' => 1,
                'created' => '2018-12-04 22:22:03',
                'modified' => '2018-12-04 22:22:03'
            ],
        ];
        parent::init();
    }
