...
<div class="row">
    <div class="col-sm-2" id="actions-sidebar">
        <div class="list-group">
            <a href="#" class="list-group-item list-group-item-action active"><?= __('Acciones') ?></a>
                ...
                __('Delete'),
                ['action' => 'delete', $organizationDirection->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $organizationDirection->id)]
            )
            ?></li>
    ...
    <div class="col-sm-10">
        <div class="organizationDirections form large-9 medium-8 columns content">
            ...
            <fieldset>
                <legend><?= __('Edit Organization Direction') ?></legend>
                <?php
