...
<div class="row">
    <div class="col-sm-2" id="actions-sidebar">
        <div class="list-group">
            <a href="#" class="list-group-item list-group-item-action active"><?= __('Acciones') ?></a>
                ...
                __('Delete'),
                ['action' => 'delete', $organizationSubdirection->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $organizationSubdirection->id)]
            )
            ?></li>
    ...
    <div class="col-sm-10">
        <div class="organizationSubdirections form large-9 medium-8 columns content">
            ...
            <fieldset>
                <legend><?= __('Edit Organization Subdirection') ?></legend>
                <?php
