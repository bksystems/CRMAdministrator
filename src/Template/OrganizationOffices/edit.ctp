...
<div class="row">
    <div class="col-sm-2" id="actions-sidebar">
        <div class="list-group">
                <a href="#" class="list-group-item list-group-item-action active"><?= __('Acciones') ?></a>
                            ...
                            __('Delete'),
                            ['action' => 'delete', $organizationOffice->id],
                            ['confirm' => __('Are you sure you want to delete # {0}?', $organizationOffice->id)]
                        )
                    ?></li>
                                    <?= $this->Html->link(__('List Organization Offices'), ['action' => 'index'], ['class' => 'list-group-item list-group-item-action']) ?>
    ...
    <div class="col-sm-10">
        <div class="organizationOffices form large-9 medium-8 columns content">
            ...
            <fieldset>
                <legend><?= __('Edit Organization Office') ?></legend>
                <?php
